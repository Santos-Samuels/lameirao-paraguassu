...
const loadProductsFinishModal = (productID, products) => {
    ...
    products.forEach(product => {
        if(product.id == productID) {
            productVideoLink = product.video
            productModalContainer.innerHTML = `
                <h4 class="border-bottom pb-1 mb-2 text-secondary">Informações da lameira</h4>
                <div class="row g-2 mb-4">
                <div class="col-12 col-lg-6">
                        <label class="form-label">Modelo</label>
                        <iframe  class="w-100 rounded" src="${product.video}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><input class="form-control d-none" type="text" name="lameiraModel" id="lameiraModel" value="${product.video}" disabled>
                    </div>
                    <div class="col-12">
